...
- [#std542, п. 1.4: Доступ к файловой системе из кода конфигурации](../../std/542.md#14) — Диагностика v8cs:missing-temporary-file-deletion проверяет требование пункта 1.4 стандарта std542.
