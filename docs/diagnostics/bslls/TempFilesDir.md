...
- [#std542, п. 1.1: Доступ к файловой системе из кода конфигурации](../../std/542.md#11) — Диагностика «Вызов функции КаталогВременныхФайлов() (TempFilesDir)» проверяет условие пункта 1.1 стандарта std542.
