...
- [#std542, п. 6: Доступ к файловой системе из кода конфигурации](../../std/542.md#6) — Диагностика «Доступ к файловой системе (FileSystemAccess)» проверяет условие пункта 6 стандарта std542.
