...
- [#std453, п. 5.8: Описание процедур и функций](../../std/453.md#58) — Диагностика «Устаревшие методы не должны использоваться (DeprecatedMethodCall)» проверяет условие пункта 5.8 стандарта std453. Примечание: Пункт 5.8 задаёт конвенцию Устарела/Deprecated; запрет вызова является защитным расширением диагностики. До редакции от мая 2026 года это был пункт 5.7.
